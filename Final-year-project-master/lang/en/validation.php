    ...
    */
    ...
    'custom' => [
        'title' => [
            ...
            'unique' => 'The title already exists',
        ],
        'description' => [
        ...
        'image' => [
            ...
            'mimes' => 'Only ::values ​​files are accepted',
            'uploaded' => 'the size of the :attribute file must not exceed 2mb',
        ],
        'category_id' => [
            'required' => 'The category field is mandatory',
        ],
        'name' => [
        ...
        'status' => [
            'required' => 'The availability field is mandatory',
        ],
        'quantity' => [
            'required' => 'Le champ quantité est obligatoire',
        ],
        'total_price' => [
            'required' => 'The price including tax field is mandatory',
        ],
        'total_received' => [
